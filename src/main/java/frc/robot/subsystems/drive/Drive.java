...
import static frc.robot.Constants.kDt;
...
public class Drive extends SubsystemBase {
  ...
  private SwerveDrivePoseEstimator poseEstimator =
      new SwerveDrivePoseEstimator(
          kinematics, rawGyroRotation, lastModulePositions, Constants.startPose);
  ...
  public Drive(
    ...
    AutoBuilder.configure(
        ...
        this::runVelocity,
        new PPHolonomicDriveController(new PIDConstants(10, 0, 1.5), new PIDConstants(7, 0, 1.5)),
        PP_CONFIG,
  ...
  public void periodic() {
    ...
    var lastPose = poseEstimator.getEstimatedPosition();
    ...
    var newPose = poseEstimator.getEstimatedPosition();
    Logger.recordOutput(
        "Drive/MPS",
        Math.sqrt(
